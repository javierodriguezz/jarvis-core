...
# TODO (Fase 1, paso 2): abrir_programa_o_web(nombre)
# TODO (Fase 1, paso 3): crear_nota(texto) / consultar_notas()
# TODO (Fase 1, paso 4): buscar_archivo(nombre, carpetas_permitidas)
# TODO (Fase 1, paso 5): responder_pregunta_simple(pregunta)
